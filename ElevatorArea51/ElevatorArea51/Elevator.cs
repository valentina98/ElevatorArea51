...
namespace ElevatorArea51
{
    ...
    class Elevator
    {
        ...
        public static Dictionary<int, string> Floors; // agent uses it to get random floor
        private static readonly object locker = new object(); // an object used to lock the elevator while moving

        Semaphore semaphore;
        public static List<Agent> agents; // list of agents in the elevator
        ...
        public static bool MoveToFloor(int toFloor)
        {
        ...
        private static bool CanOpenDoor()
        {
